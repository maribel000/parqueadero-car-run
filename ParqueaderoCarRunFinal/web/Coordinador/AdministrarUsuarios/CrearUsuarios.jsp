...
<title>CrearUsuariosCoordinador</title>
...
<fieldset><legend style="font-weight: bold;"><big><big>Crear&nbsp;
Usuarios</big></big></legend>
<div style="text-align: justify;"><big>Ingrese la informacion
Para el Nuevo Usuario <br>
<br>
Cedula&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
name="CedulaCrearUsuario"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;<input name="CrearUsuario" value="Crear Usuario" type="submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</big><a href="AdministrarUsuarios.jsp"><big><input
name="CancelarCrearUsuario" value="Cancelar" type="submit"></big></a> </div>
<br>
<br>
</fieldset>
<br>
